...
class CategoryIcon extends Field\Text
{
    ...
    var icons               =   ["iconfont icon-muyin-qinju","iconfont icon-nanshi-nanxie","iconfont icon-nvshi-peishi","iconfont icon-dianqi-peijian","iconfont icon-nvshi-jiajufu",
                                ...
                                "iconfont icon-nvshi-lianyiqun","iconfont icon-dianqi-dianshi","iconfont icon-qita-wenju","iconfont icon-yinshi-baojianpin","iconfont icon-muyin-chechuangyongpin",
                                ...
                                "iconfont icon-nvshi-zhenzhishan","iconfont icon-nanshi-xizhuang","iconfont icon-xihu-xifahufa","iconfont icon-jiaju-jujiabuyi","iconfont icon-muyin-yunchan",
                                "iconfont icon-nanshi-peishi","iconfont icon-nanshi-nanbao","iconfont icon-yinshi-jiulei","iconfont icon-nanshi-jiajufu","iconfont icon-dianqi-bangong",
                                ...
                                "iconfont icon-nanshi-zhenzhishan","iconfont icon-jiaju-dengshi","iconfont icon-yinshi-shicai","iconfont icon-dianqi-gehujiankang","iconfont icon-qita-qipei",
